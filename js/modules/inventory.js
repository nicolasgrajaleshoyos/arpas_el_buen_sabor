    ...
    renderProductsTable() {
        ...
        tbody.innerHTML = this.currentProducts.map(product => `
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 font-semibold text-gray-900">$${product.price.toLocaleString()}</td>
                <td class="px-6 py-4 font-semibold text-emerald-600">$${(product.stock * product.price).toLocaleString()}</td>
                <td class="px-6 py-4">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Gestión de productos terminados</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-soft p-4">
                    <div class="relative">
                        ...
                        <input 
                            type="text" 
                            id="search-products" 
                            class="pl-10 w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            ...
            <div id="product-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6 slide-in">
                    <div class="flex items-center justify-between mb-6">
                        <h2 id="modal-title" class="text-2xl font-bold text-gray-900">Nuevo Producto</h2>
                        <button onclick="Inventory.closeModal()" class="text-gray-400 hover:text-gray-600">
                    ...
                    <form id="product-form" class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="product-name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Categoría</label>
                            <input type="text" id="product-category" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Precio</label>
                            <input type="number" id="product-price" min="0" step="100" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Stock</label>
                            <input type="number" id="product-stock" min="0" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div class="flex gap-3 pt-4">
                            <button type="button" onclick="Inventory.closeModal()" class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium">
                                Cancelar
                            </button>

...
const Suppliers = {
            ...
            <div class="bg-white rounded-xl shadow-soft p-6 card-hover">
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">NIT: ${supplier.nit}</p>
                    </div>
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    ...
                    <p class="text-sm text-gray-700">${supplier.products}</p>
                </div>
            </div>
        `).join('');
    },
    ...
    render() {
        return `
            <div class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Directorio de proveedores y contactos</p>
                    </div>
            ...
            <!-- Supplier Modal -->
            <div id="supplier-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div class="bg-white rounded-xl shadow-xl max-w-md w-full p-6 slide-in">
                    <div class="flex items-center justify-between mb-6">
                        <h2 id="supplier-modal-title" class="text-2xl font-bold text-gray-900">Nuevo Proveedor</h2>
                        <button onclick="Suppliers.closeModal()" class="text-gray-400 hover:text-gray-600">
                    ...
                    <form id="supplier-form" class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="supplier-name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">NIT</label>
                            <input type="text" id="supplier-nit" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500" required>
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Teléfono</label>
                            <input type="tel" id="supplier-phone" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" id="supplier-email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Dirección</label>
                            <input type="text" id="supplier-address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                        
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Productos que Suministra</label>
                            <textarea id="supplier-products" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"></textarea>
                        </div>
                        
                        <div class="flex gap-3 pt-4">
                            <button type="button" onclick="Suppliers.closeModal()" class="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium">
                                Cancelar
                            </button>
